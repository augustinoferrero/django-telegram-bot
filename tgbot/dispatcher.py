...
from tgbot.handlers.onboarding.manage_data import START, BALANCE, BUY_OR_DECLINE, FASOFKA, READY, \
    DISTRICT, KLAD_TYPE, READYC, DISTRICTC, FASOFKAC, KLAD_TYPEC, CONFIRM_ZK
from tgbot.handlers.broadcast_message.manage_data import CONFIRM_DECLINE_BROADCAST
from tgbot.handlers.broadcast_message.static_text import referral_command
...
def setup_dispatcher(dp):
    ...
    # courier
    dp.add_handler(MessageHandler(Filters.regex(r'Добавить товар'), onboarding_handlers.courier_menu_handler))
    dp.add_handler(MessageHandler(Filters.regex(r'Статистика'), onboarding_handlers.courier_menu_handler))
